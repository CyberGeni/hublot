  ...
  return (
    <section className="text-white grid grid-cols-[9%_auto_9%] md:grid-cols-[6%_auto_6%]  bg-[url('./assets/bg-pattern-noise.svg')] h-screen w-full bg-black bg-center  bg-blend-normal bg-no-repeat bg-cover">
        ...
        <div className="h-full border-white/30 border-x flex flex-col justify-between">
          <h1 className="font-sans text-white/80 py-3 sm:py-6 w-full h-fit text-center text-lg sm:text-2xl border-b border-white/30">
            HUBLOT
          </h1>
          {/* main content */}
          <main>
            ...
            <section className="relative p-8 flex flex-col md:flex-row items-center h-full my-auto">
              <div>
                <h1 className="relative z-20 sm:whitespace-nowrap md:whitespace-normal text-4xl md:text-5xl lg:text-6xl text-[#E4E4E7]">
                  Elegance and Precision: <br />{" "}
                  <span className="text-white/60">
                    The finest luxury watches.
                  </span>
                </h1>
                <p className="font-sans text-white/80 relative z-20 w-5/6 sm:w-3/5 sm:text-justify my-5">
                  Experience the timeless beauty and unparalleled craftsmanship
                  of our luxurious timepieces. Each piece is meticulously
                  designed and crafted using only the finest materials, ensuring
              ...
              <div className="w-full sm:w-2/3 md:w-full absolute lg:static -right-1 ml-0 opacity-30 sm:opacity-70 md:opacity-100  sm:z-10  sm:blur-none md:blur-none -bottom-8">
                <img
                  className="w-3/5 sm:w-2/3 md:w-2/5 lg:w-4/5 absolute lg:static -bottom-12 md:-bottom-28 right-0 -z-10"
                  src={heroWatch}
                  alt=""
                />
              </div>
